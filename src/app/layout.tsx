...
export const metadata: Metadata = {
  title: "PurpleRealty - Premium Real Estate Services",
  description: "Find your dream property with PurpleRealty. Expert real estate services for buyers, sellers, and investors in the metropolitan area.",
  keywords: "real estate, properties, homes, buying, selling, investment, luxury properties",
  metadataBase: new URL("https://purplerealty.com"),
  alternates: {
    canonical: "https://purplerealty.com"
  },
  openGraph: {
    title: "PurpleRealty - Premium Real Estate Services",
    description: "Find your dream property with PurpleRealty. Expert real estate services for buyers, sellers, and investors.",
    siteName: "PurpleRealty",
    type: "website",
    images: [{
      url: "https://images.pexels.com/photos/18341129/pexels-photo-18341129.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
  ...
  twitter: {
    ...
    title: "PurpleRealty - Premium Real Estate Services",
    description: "Find your dream property with expert real estate guidance",
    images: ["https://images.pexels.com/photos/18341129/pexels-photo-18341129.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
